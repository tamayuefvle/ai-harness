...
<!-- Source: harness/rules/harness.md; consumer: codex; run npm run harness:generate -->
...
<!-- GENERATED FILE. DO NOT EDIT DIRECTLY. -->
<!-- Source: harness/rules/profiles.md; consumer: codex; run npm run harness:generate -->
